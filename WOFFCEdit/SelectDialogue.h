...
public:
	...
	void SetObjectData(std::vector<SceneObject>* SceneGraph, std::vector<unsigned int> * Selection, class UndoRedoActions* undoRedoActions);	//passing in pointers to the data the class will operate on.
	
// Dialog Data
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_SelectDialogue};
#endif
