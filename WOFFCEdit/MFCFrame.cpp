...
int CMyFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndStatusBar.SetIndicators(indicators, indicatorCount);
	m_wndStatusBar.SetPaneInfo(0, ID_SEPARATOR, SBPS_NORMAL, rect.Width() / indicatorCount * 1.4);
	m_wndStatusBar.SetPaneInfo(1, ID_INDICATOR_TOOL, SBPS_NORMAL, rect.Width() / indicatorCount * 0.5);// EDIT MODE pane	
	m_wndStatusBar.SetPaneInfo(2, ID_INDICATOR_TOOL, SBPS_NORMAL, rect.Width() / indicatorCount);//set width of status bar showing selected objects panel
